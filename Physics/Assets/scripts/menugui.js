...
function Awake () {
    ...
    buttonPos6 = topBannerH+buttonSizeH*5;
...
function OnGUI() {
	...
	if (GUI.Button(Rect(0,buttonPos5,buttonSizeW,buttonSizeH),"virtual room")){
		...
		Application.LoadLevel("virtual");
	}
	
	if (GUI.Button(Rect(0,buttonPos6,buttonSizeW,buttonSizeH),"information")){
		Debug.Log("Clicked the button information");
